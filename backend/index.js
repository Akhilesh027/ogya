...
const sendEmail = async (to, subject, text) => {
  try {
    ...
    let mailOptions = {
      from: 'bannureddykallem@gmail.com', // Replace with your email
      to: to,
      subject: subject,
      text: text,
    };
...
const sendAdminNotification = async (firstName, amount, transactionId) => {
  try {
    ...
    let mailOptions = {
      from: 'bannureddykallem@gmail.com', // Replace with your email
      to: 'bannureddykallem@gmail.com', // Replace with admin's email
...
Email: [Your Company Email]`;
      ...
      await sendEmail('bannureddykallem@gmail.com', subject, text);
